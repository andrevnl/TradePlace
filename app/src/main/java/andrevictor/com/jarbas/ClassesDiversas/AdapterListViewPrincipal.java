...
public class AdapterListViewPrincipal extends BaseAdapter
{
    private LayoutInflater mInflater;
    private ArrayList<ItemListView> itens;

    public AdapterListViewPrincipal(Context context, ArrayList<ItemListView> itens)
    {
    ...
    public View getView(int position, View view, ViewGroup parent)
    {
        ...
        view = mInflater.inflate(R.layout.item_listprincipal, null);
